...
const EncryptData = (props) => {
    ...
    const onFinish = () => {
        ...
        api.open({
            message: 'Note',
            description:
              'Please make sure to remember or store the password somewhere safe, it will be used to decrypt your data.',
            icon: (
              <SmileOutlined
                style={{
                  color: '#108ee9',
    ...
    return (
        <>
            {contextHolder}
            <div>
                <Title level={3} style={{ marginTop: 10 }}>Encrypt Your Data Online</Title>
                <Form
                    layout='vertical'
                    form={form}
                    onFinish={onFinish}
                ...
                >
                    ...
                    <div>
                        <Form.Item>
                            <Button htmlType='submit' type="primary">Encrypt</Button>
                        </Form.Item>
                    </div>
                </Form>
            </div>
...
const EncryptFile = () => {
    ...
    return (
        <>
            {contextHolder}
            <div>
                <Title level={3} style={{ marginTop: 10 }}>Encrypt A File Online</Title>
                <Form
                    layout='vertical'
                    form={form}
                    onFinish={onFinish}
    ...
    const items = [
        {
          key: '1',
          label: `Data`,
          children: <EncryptData />,
        },
        {
          key: '2',
          label: `File`,
          children: <EncryptFile />,
        },
    ];
